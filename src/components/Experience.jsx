...
const experienceData = [
  {
    ...
    achievements: [
      ...
      "Engineered real-time communication systems using Socket.IO WebSockets for direct messaging with read receipts, typing indicators, online status tracking, and push notifications; implemented conversation management with unread count tracking and soft-delete functionality.",
      "Built scalable social networking features including hybrid follow system (denormalized counts + separate collection), mentorship program matching, community management with member roles, content feed with pagination, and structured opportunity posting system",
      "Implemented enterprise-grade security and authentication supporting multi-provider OAuth (Google, Apple, Facebook) with JWT, role-based access control (RBAC), rate limiting, Helmet security headers, bcrypt password hashing, and email OTP verification system",
      "Integrated multiple third-party services including Paystack for subscription payments, Cloudinary for media storage, Firebase Cloud Messaging (FCM) for push notifications, SendGrid for transactional emails, and automated cron jobs for subscription management.",
      "Ensured data integrity with MongoDB Atlas leveraging atomic transactions for multi-document operations, compound unique indexes, TTL indexes for auto-cleanup, aggregation pipelines for analytics, and optimized query performance with strategic denormalization and indexing.",
      "Established development best practices with Zod schema validation, comprehensive API documentation via Swagger/OpenAPI 3.0, centralized error handling with custom error classes, standardized response formatting, and automated database migration scripts",
    ],
  },
  {
    id: 2,
    ...
    achievements: [
      ...
      "Implemented Third party integrations: Paystack for secure payments and Cloudinary for optimized image handling and media storage.",
